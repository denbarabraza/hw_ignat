...
export const filterAffairs = (affairs: Array<AffairType>, filter: FilterType): Array<AffairType> => { // need to fix any
    ...
    if(filter==='high'){
        return affairs.filter((el:AffairType)=>el.priority==='high')
    }
    if(filter==='low'){
        return affairs.filter((el:AffairType)=>el.priority==='low')
    }
    if(filter==='middle'){
        return affairs.filter((el:AffairType)=>el.priority==='middle')
    }
    return affairs
     // need to fix
}
